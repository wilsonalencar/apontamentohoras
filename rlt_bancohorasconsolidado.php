...
<div class="header"> 
            <h1 class="page-header">
                Banco horas consolidado
            </h1>
            <ol class="breadcrumb">
          <li><a href="#">Relatórios</a></li>
          <li class="active">Banco horas consolidado</li>
        </ol> 
    ...
    <div class="col-md-12">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example" style="display: none">
                        ...
                        <tbody>
                            ...
                            <?php
                            if (!empty($fechamentoapontamento->array)) {
                             foreach($fechamentoapontamento->array as $id_func => $dados) {
                                if (is_integer($id_func)) {
                            ?>
        ...
        <!-- Modal de Pesquisa -->
            <div id="ModalPesquisa" class="modal fade" >
                ...
                <form class="col s12" action="rlt_bancohorasconsolidado.php" method="get" name="data">
                  <div class="modal-body">
                    <div class="row">
                      <div class="col s4" >
                          Ano
                          <input type="number" name="data" class="validate" value="" maxlength="4">
                      </div>
                    </div>
...
$('#dataTables-example').dataTable({
        ...
        <?php if (!empty($fechamentoapontamento->data)) { ?>
        buttons: [
             {
                extend: 'excelHtml5',
                exportOptions: {
                  ...
                  doc.styles.tableHeader.fontSize = 7;
                      ...
                      return {
                        columns: [
                          ...
                          {
                            alignment: 'center',
                            text: 'Banco de Horas Consolidado em : <?php echo $fechamentoapontamento->data; ?>',
                            fontSize: 13,
                            margin: [10,0]
                          }
                        ],
