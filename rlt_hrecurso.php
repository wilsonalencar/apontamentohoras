                ...
                <form class="col s12" action="rlt_hrecurso.php" method="post" name="funcionario">
                    <div class="modal-body">
                      <div class="row">
                        ...
                        <select id="id_funcionario" name="id" class="form-control input-sm">
                            <option value="">Profissional</option>
                                <?php $funcionario->montaSelect($funcionario->id); ?>
                            </select>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col s4">
                            Data Início
                            <input type="date" name="data_busca_ini" class="validate" value="<?php if (!empty($funcionario->data_busca_ini)) {
                              echo $funcionario->data_busca_ini;
                            } ?>" maxlength="8">
                        </div>
                        <div class="col s4">
                            Data Fim
                            <input type="date" name="data_busca_fim" class="validate" value="<?php if (!empty($funcionario->data_busca_fim)) {
                              echo $funcionario->data_busca_fim;
                            }?>" maxlength="8">
                        </div>
                      </div>
