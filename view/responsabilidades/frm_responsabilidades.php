            ...
            <h1 class="page-header">
                 Responsabilidades
					...
					<ol class="breadcrumb">
					  ...
					  <li class="active">Cadastro de Responsabilidades</li>
					</ol> 
         ...
         <div id="page-inner"> 
    		 ...
    		 <div class="card">
                ...
                <div class="card-content">
                    ...
                    <form class="col s12" action="responsabilidades.php" method="post" name="cad_responsabilidades">
                      <div class="row">
                        <div class="col s3">
...
?>
<script src="<?php echo app::dominio; ?>view/assets/js/responsabilidades/responsabilidade.js"></script>