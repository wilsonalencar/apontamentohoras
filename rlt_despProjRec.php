    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-action">
                 Selecione um Projeto ou um funcionário para geração do relatório.
            </div>
...
$('#dataTables-example').dataTable({
        ...
        buttons: [
             ...
             },
             {
                ...
                pageSize: 'LEGAL',
                title: 'Despesas por Projeto e Recurso \n <?php echo $projetodados; ?>',
                header: 'Despesas por Projeto e Recurso'
             },
         ]
    });  
